...
#    {'id':3, 'name':'learning OOP'},

# ] 

# creating the login page for the user to enter
...
def room(request,pk):
    ...
    # for the wiritng the messabe by the user 
    if request.method =='POST':
...
# not allowing all user to edit or delete the others info by using decorators
...
def updateRoom(request,pk):
    ...
    topics=Topic.objects.all()
     ...
     # checking weather he or she is host or not
